...
- `scripts/import_archive_csv.php` - imports legacy CSV rows into `archive_items` inside `data/intake.sqlite`.
- `scripts/build_archive_db.php` - copies `archive_items` into the standalone `data/archive.sqlite` archive database.
