...
- **SKU lookup (home):** dedicated two-pane area. Left: SKU + status filters + quick chips (Intake/Listed/Sold/Stale >7d); right: live preview table. Type 2+ chars or pick a status; “Refresh preview” forces an update.
